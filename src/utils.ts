...
export const ruleCreator = ESLintUtils.RuleCreator<{ recommended: boolean }>(
  (name) =>
    `https://github.com/manbearwiz/eslint-plugin-rxjs-angular/tree/main/docs/rules/${name}.md`,
);
